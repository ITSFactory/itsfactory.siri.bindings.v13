...
public class Comment {
    ...
    protected Comment.Comment2 comment;
     ...
     *     
     */
    public void setComment(Comment.Comment2 value) {
        this.comment = value;
    }
    ...
    public static class Comment2 {
        ...
        @XmlElement(required = true)
        protected List<Comment.Comment2.Value> value;
         ...
         * {@link Comment2.Comment.Value }
         * 
         * 
         */
        public List<Comment.Comment2.Value> getValue() {
            if (value == null) {
                value = new ArrayList<Comment.Comment2.Value>();
            }
            return this.value;
        }
